...
export default function Navbar({selectedTab , setSelectedTab })  {
    ...
    const navigation = [
        { title: "Home", path: "javascript:void(0)", name: "Home"},
        { title: "Create Post", path: "javascript:void(0)" , name: "Post"  }
    ]
                    ...
                    <ul className="justify-center items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                        {
                            navigation.map((item, idx) => {
                                return (
                                    <li onClick={() => {handleOnClick(item.name)}} key={idx} className="text-gray-700 hover:text-gray-900">
